const SITE_URL = 'https://walkyourownpath.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'Walk Your Own Path — Sonic Remedy | Soozhee', text: 'Walk Your Own Path by Soozhee. Sonic Remedy : Audiosensory Resonance | Trust Your Path.', url: SITE_URL }); return; } catch (e) {} }
